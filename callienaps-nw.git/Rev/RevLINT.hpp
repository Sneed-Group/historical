...
#define LUAVM_SHUFFLE7(sep,a0,a1,a2,a3,a4,a5,a6,a7) a2 sep a3 sep a0 sep a4 sep a6 sep a1 sep a5
...
typedef struct r_LClosure {
	int *next;					// +00  00 
	lu_byte marked;				// +04  04 
	lu_byte tt;					// +05  05 
	lu_byte isC;					// +06  06 
	lu_byte nupvalues;				// +07  07 
	int *gclist;				// +08  08  
	int *env;					// +0C  12 
	int *p;						// +10  16
	int upvals[1];				// +14  20 
...
typedef struct r_TString {
	...
	lu_byte marked;				// +04  04
	lu_byte tt;					// +05  05
	lu_byte reserved_0;			// +06  06
	lu_byte reserved_1;			// +07	07
...
typedef struct r_Proto {
	...
	int unk_9;					// +68	44
	lu_byte maxstacksize;			// +72	48
	lu_byte numparams;				// +73	49
	lu_byte nups;					// +74	4A
	lu_byte is_vararg;				// +75	4B
};
...
void rev_luaC_link(int r_lua_State, int o, lu_byte tt);
