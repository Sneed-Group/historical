...
Assumeutxo is a feature that allows fast bootstrapping of a validating moneyrocketd
...
- [Github issue](https://github.com/moneyrocket/moneyrocket/issues/15605)
- [draft PR](https://github.com/moneyrocket/moneyrocket/pull/15606)
...
considered active. This is the "traditional" mode of operation for moneyrocketd.
...
**Failure consideration:** if moneyrocketd unexpectedly halts after `m_stop_use` is set on
...
### Moneyrocketd restarts sometime after snapshot validation has completed

When moneyrocketd initializes again, what began as the snapshot chainstate is now
