...
This document provides guidelines for internationalization of the Moneyrocket Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `moneyrocket_en.ts` remains unchanged.
