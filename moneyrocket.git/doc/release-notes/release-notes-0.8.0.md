Moneyrocket-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/moneyrocket/files/Moneyrocket/moneyrocket-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Moneyrocket
...
New/changed settings (command-line or moneyrocket.conf file)
--------------------------------------------------------
