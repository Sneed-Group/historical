Moneyrocket version 0.5.4 is now available for download at:
http://sourceforge.net/projects/moneyrocket/files/Moneyrocket/moneyrocket-0.5.4/
...
http://gitorious.org/moneyrocket/moneyrocketd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Moneyrocket-Qt notifications under Growl 1.3.
Increase required age of Moneyrocket-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMoneyrocket properly when installing Moneyrocket-Qt over it. (Windows)
