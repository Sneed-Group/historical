Moneyrocket Core version 0.16.1 is now available from:

  <https://moneyrocketcore.org/bin/moneyrocket-core-0.16.1/>
...
- #12843 `df38b13` Test starting moneyrocketd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure moneyrocketd processes are cleaned up when tests end (sdaftuar)
