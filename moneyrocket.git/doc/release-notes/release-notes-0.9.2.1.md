Moneyrocket Core version 0.9.2.1 is now available from:

  https://moneyrocket.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RKT to 0.01 RKT
...
- Fix "Start moneyrocket on system login"
