Moneyrocket Core version 0.9.4 is now available from:

  https://moneyrocket.org/bin/0.9.4/
...
this update is incompatible with the Moneyrocket system and could lead to consensus
forks.

Moneyrocket Core released binaries from https://moneyrocket.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~moneyrocket/+archive/ubuntu/moneyrocket
- A third-party or self-compiled Moneyrocket Core

upgrade to Moneyrocket Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
