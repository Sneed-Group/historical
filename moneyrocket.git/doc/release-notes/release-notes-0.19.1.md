...
Moneyrocket Core version 0.19.1 is now available from:

  <https://moneyrocketcore.org/bin/moneyrocket-core-0.19.1/>
...
From Moneyrocket Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Moneyrocket Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Moneyrocket Core does not yet change appearance when
...
- #17488 fix "moneyrocketd already running" warnings on macOS (fanquake)
