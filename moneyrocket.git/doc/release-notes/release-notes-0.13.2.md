Moneyrocket Core version 0.13.2 is now available from:

  <https://moneyrocket.org/bin/moneyrocket-core-0.13.2/>
...
- #8908 `4a974b2` Update moneyrocket-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow moneyrocket-tx to create v2 transactions (rktdrak)
