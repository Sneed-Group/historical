Moneyrocket Core version *0.15.0.1* is now available from:

  <https://moneyrocket.org/bin/moneyrocket-core-0.15.0.1/>

and

  <https://moneyrocketcore.org/bin/moneyrocket-core-0.15.0.1/>
