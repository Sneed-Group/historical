Moneyrocket Core version *0.15.2* is now available from:

  <https://moneyrocketcore.org/bin/moneyrocket-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in moneyrocket-tx (TheBlueMatt)
