Moneyrocket Core version 0.10.4 is now available from:

  <https://moneyrocket.org/bin/moneyrocket-core-0.10.4/>
...
- #6953 `43c2789` Split moneyrocket-tx into its own package
- #6953 `dfe0d4d` Include moneyrocket-tx binary on Debian/Ubuntu
