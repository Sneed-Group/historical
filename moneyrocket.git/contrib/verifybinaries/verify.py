...
"""Script for verifying Moneyrocket Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
moneyrocketcore.org and moneyrocket.org and compares them.
...
WORKINGDIR = "/tmp/moneyrocket_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://moneyrocketcore.org"
HOST2 = "https://moneyrocket.org"
VERSIONPREFIX = "moneyrocket-core-"
...
def main(args):
    ...
    if not success:
        print("moneyrocket.org failed to provide signature file, "
              "but moneyrocketcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("moneyrocket.org and moneyrocketcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Moneyrocket Core binary release "
