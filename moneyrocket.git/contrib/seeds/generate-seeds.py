...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MONEYROCKET_CHAINPARAMSSEEDS_H\n')
    g.write('#define MONEYROCKET_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the moneyrocket network\n')
    ...
    g.write('#endif // MONEYROCKET_CHAINPARAMSSEEDS_H\n')
