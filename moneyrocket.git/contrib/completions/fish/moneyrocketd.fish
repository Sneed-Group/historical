...
complete --command moneyrocketd --no-files

# Extract options
function __fish_moneyrocketd_get_options
...
complete \
    --command moneyrocketd \
    --arguments "(__fish_moneyrocketd_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command moneyrocketd \
...
complete \
    --command moneyrocketd \
    --arguments "(__fish_moneyrocketd_get_options --nofiles)"
