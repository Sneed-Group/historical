...
complete --command moneyrocket-qt --no-files

# Extract options
function __fish_moneyrocketqt_get_options
...
complete \
    --command moneyrocket-qt \
    --arguments "(__fish_moneyrocketqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c moneyrocket-qt \
...
complete \
    --command moneyrocket-qt \
    --arguments "(__fish_moneyrocketqt_get_options --nofiles)"
