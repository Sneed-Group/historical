...
# Extract options
function __fish_moneyrocket_tx_get_options
...
# Extract commands
function __fish_moneyrocket_tx_get_commands
...
# Add options
complete \
    --command moneyrocket-tx \
    --condition "not __fish_moneyrocket_seen_cmd (__fish_moneyrocket_tx_get_commands --commandsonly)" \
    --arguments "(__fish_moneyrocket_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command moneyrocket-tx \
    --arguments "(__fish_moneyrocket_tx_get_commands)" \
    --no-files
