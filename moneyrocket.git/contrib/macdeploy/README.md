...
When complete, it will have produced `Moneyrocket-Core.dmg`.
...
apt install cpio
git clone https://github.com/moneyrocket-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/moneyrocket-core/moneyrocket-detached-sigs).
