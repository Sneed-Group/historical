...
"""Example logging Moneyrocket Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/moneyrocketd
...
def main(moneyrocketd_path):
    ...
    b = BPF(text=program, usdt_contexts=[moneyrocketd_with_usdts])
