Contributing to Moneyrocket Core
============================

The Moneyrocket Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Moneyrocket Core
...
Before you start contributing, familiarize yourself with the Moneyrocket Core build
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to moneyrocket-qt
...
fork of Moneyrocket Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/moneyrocket/moneyrocket/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Moneyrocket Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Moneyrocket
Network Protocol consensus changes.

Whether a pull request is merged into Moneyrocket Core rests with the project merge
maintainers.
...
Patches that change Moneyrocket consensus rules are considerably more involved than
...
Where a patch set proposes to change the Moneyrocket consensus, it must have been
