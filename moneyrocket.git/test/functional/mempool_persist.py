...
By default, moneyrocketd will dump mempool on shutdown and
...
class MempoolPersistTest(MoneyrocketTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent moneyrocketd from writing mempool.dat to disk. Verify that `savemempool` fails")
