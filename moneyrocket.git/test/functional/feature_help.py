#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Moneyrocket Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting moneyrocket with -h works as expected."""

from test_framework.test_framework import MoneyrocketTestFramework
from test_framework.util import assert_equal

class HelpTest(MoneyrocketTestFramework):
    ...
    def run_test(self):
        self.log.info("Start moneyrocket with -h for help text")
        ...
        self.log.info("Start moneyrocket with -version for version information")
        ...
        self.log.info("Start moneyrocketd with -fakearg to make sure it does not start")
