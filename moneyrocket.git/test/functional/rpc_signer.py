...
Verify that a moneyrocketd node can use an external signer command.
...
class RPCSignerTest(MoneyrocketTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart moneyrocketd with -signer=<cmd>',
