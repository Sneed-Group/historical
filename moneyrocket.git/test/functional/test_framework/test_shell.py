...
class TestShell:
    """Wrapper Class for MoneyrocketTestFramework.

    The TestShell class extends the MoneyrocketTestFramework
    ...
    class __TestShell(MoneyrocketTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MoneyrocketTestFramework child class.
            self.num_nodes = 1
