...
"""
Test starting moneyrocketd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MoneyrocketTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that moneyrocketd has bound on "::1" (for RPC) and "::" (for P2P).
