...
class TxnMallTest(MoneyrocketTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 RKT:
        ...
        # First: use raw transaction API to send 1240 RKT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RKT coin each
        ...
        # Node0's balance should be starting balance, plus 50RKT for another
        ...
        # Node0's total balance should be starting balance, plus 100RKT for
