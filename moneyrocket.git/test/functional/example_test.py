...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MoneyrocketTestFramework
    pass


class ExampleTest(MoneyrocketTestFramework):
    # Each functional test is a subclass of the MoneyrocketTestFramework class.
    ...
    def custom_method(self):
        ...
        MoneyrocketTestFramework class so other tests can use it."""
