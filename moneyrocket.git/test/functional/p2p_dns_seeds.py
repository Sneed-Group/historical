...
class P2PDNSSeeds(MoneyrocketTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default moneyrocketd settings
        self.restart_node(0)
    ...
    def existing_outbound_connections_test(self):
        ...
        self.nodes[0].addpeeraddress("192.0.0.8", 9876)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in moneyrocketd, but 0 in the test framework,
    ...
    def wait_time_tests(self):
        ...
        for i in range(5):
            a = f"192.0.0.{i}"
            self.nodes[0].addpeeraddress(a, 9876)
