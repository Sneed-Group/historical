...
# TestP2PConn: A peer we use to send messages to moneyrocketd, and store responses.
...
class CompactBlocksTest(MoneyrocketTestFramework):
    ...
    # This test actually causes moneyrocketd to (reasonably!) disconnect us, so do this last.
    ...
    # moneyrocketd's choice of nonce.
    ...
    # Test that moneyrocketd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for moneyrocketd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # moneyrocketd will not send blocktxn responses for blocks whose height is
