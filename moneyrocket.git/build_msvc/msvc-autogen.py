...
libs = [
    ...
    'libmoneyrocket_crypto',
    'libmoneyrocket_node',
    'libmoneyrocket_util',
    'libmoneyrocket_wallet_tool',
    'libmoneyrocket_wallet',
    'libmoneyrocket_zmq',
    'bench_moneyrocket',
    'libtest_util',
]
...
def parse_config_into_rkt_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Moneyrocket Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/moneyrocket_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/moneyrocket_config.h'), "w", encoding="utf8") as rkt_config:
        rkt_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='Moneyrocket-core msbuild configuration initialiser.')
    ...
    parse_config_into_rkt_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/moneyrocket_config.h'), os.path.join(SOURCE_DIR, 'config/moneyrocket-config.h'))
