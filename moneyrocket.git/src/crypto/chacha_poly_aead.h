// Copyright (c) 2019-2021 The Moneyrocket Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_CRYPTO_CHACHA_POLY_AEAD_H
#define MONEYROCKET_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@moneyrocket.
 *
 ...
 *
 * The chacha20-poly1305@moneyrocket combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@moneyrocket cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@moneyrocket are relatively fast in
...
#endif // MONEYROCKET_CRYPTO_CHACHA_POLY_AEAD_H
