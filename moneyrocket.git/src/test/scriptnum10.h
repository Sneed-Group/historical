...
#ifndef MONEYROCKET_TEST_SCRIPTNUM10_H
#define MONEYROCKET_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Moneyrocket Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MONEYROCKET_TEST_SCRIPTNUM10_H
