// Copyright (c) 2023 The Moneyrocket Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_TEST_UTIL_RANDOM_H
#define MONEYROCKET_TEST_UTIL_RANDOM_H
...
#endif // MONEYROCKET_TEST_UTIL_RANDOM_H
