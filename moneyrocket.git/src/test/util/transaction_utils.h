// Copyright (c) 2019-2020 The Moneyrocket Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_TEST_UTIL_TRANSACTION_UTILS_H
#define MONEYROCKET_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // MONEYROCKET_TEST_UTIL_TRANSACTION_UTILS_H
