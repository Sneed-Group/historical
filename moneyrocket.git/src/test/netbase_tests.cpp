...
{
    BOOST_CHECK(TestSplitHost("www.moneyrocketcore.org", "www.moneyrocketcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.moneyrocketcore.org]", "www.moneyrocketcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.moneyrocketcore.org:80", "www.moneyrocketcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.moneyrocketcore.org]:80", "www.moneyrocketcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::9876", "::9876", 0));
    BOOST_CHECK(TestSplitHost(":9876", "", 9876));
    BOOST_CHECK(TestSplitHost("[]:9876", "", 9876));
    ...
    BOOST_CHECK(TestSplitHost("www.moneyrocketcore.org:65536", "www.moneyrocketcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.moneyrocketcore.org:0", "www.moneyrocketcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.moneyrocketcore.org:", "www.moneyrocketcore.org:", 0, false));
}
