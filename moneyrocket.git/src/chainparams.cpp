...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.moneyrocket.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.moneyrocket.dashjr.org."); // Luke Dashjr
        vSeeds.emplace_back("seed.moneyrocketstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.moneyrocket.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.rkt.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.moneyrocket.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.moneyrocket.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.moneyrocket.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.trkt.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.moneyrocket.sprovoost.nl.");
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("seed.signet.moneyrocket.sprovoost.nl.");

            // Hardcoded nodes can be removed once there are more DNS seeds
            vSeeds.emplace_back("178.128.221.177");
            vSeeds.emplace_back("v7ajjeirttkbnt32wpy3c6w3emwnfr3fkla7hpxcfokr3ysd3kqtzmqd.onion:39876");
