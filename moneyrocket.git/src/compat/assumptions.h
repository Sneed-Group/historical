...
#ifndef MONEYROCKET_COMPAT_ASSUMPTIONS_H
#define MONEYROCKET_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Moneyrocket cannot be compiled without assertions."
#endif
...
#endif // MONEYROCKET_COMPAT_ASSUMPTIONS_H
