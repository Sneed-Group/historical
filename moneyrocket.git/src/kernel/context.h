...
#ifndef MONEYROCKET_KERNEL_CONTEXT_H
#define MONEYROCKET_KERNEL_CONTEXT_H

#include <memory>

namespace kernel {
//! Context struct holding the kernel library's logically global state, and
//! passed to external libmoneyrocket_kernel functions which need access to this
...
#endif // MONEYROCKET_KERNEL_CONTEXT_H
