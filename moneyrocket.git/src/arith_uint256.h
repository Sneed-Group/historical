...
#ifndef MONEYROCKET_ARITH_UINT256_H
#define MONEYROCKET_ARITH_UINT256_H
...
public:
     ...
     *
     * Moneyrocket only uses this "compact" format for encoding difficulty
...
#endif // MONEYROCKET_ARITH_UINT256_H
