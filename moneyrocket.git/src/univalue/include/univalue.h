...
// Copyright 2015 Moneyrocket Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_UNIVALUE_INCLUDE_UNIVALUE_H
#define MONEYROCKET_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // MONEYROCKET_UNIVALUE_INCLUDE_UNIVALUE_H
