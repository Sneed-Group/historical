...
#ifndef MONEYROCKET_HEADERSSYNC_H
#define MONEYROCKET_HEADERSSYNC_H
 ...
 *
 * The Moneyrocket protocol does not offer an easy way to determine the work on a
...
#endif // MONEYROCKET_HEADERSSYNC_H
