// Copyright (c) 2015-2018 The Moneyrocket Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_CORE_MEMUSAGE_H
#define MONEYROCKET_CORE_MEMUSAGE_H
...
#endif // MONEYROCKET_CORE_MEMUSAGE_H
