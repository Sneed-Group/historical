...
#ifndef MONEYROCKET_INTERFACES_NODE_H
#define MONEYROCKET_INTERFACES_NODE_H
...
//! Top-level interface for a moneyrocket node (moneyrocketd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or moneyrocket.conf.
...
#endif // MONEYROCKET_INTERFACES_NODE_H
