...
#ifndef MONEYROCKET_INTERFACES_INIT_H
#define MONEYROCKET_INTERFACES_INIT_H
...
//! (moneyrocket-gui, moneyrocket-node, moneyrocket-wallet, moneyrocketd, moneyrocket-qt) and each
...
#endif // MONEYROCKET_INTERFACES_INIT_H
