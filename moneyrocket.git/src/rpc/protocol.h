...
#ifndef MONEYROCKET_RPC_PROTOCOL_H
#define MONEYROCKET_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in moneyrocketd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Moneyrocket is not connected
...
#endif // MONEYROCKET_RPC_PROTOCOL_H
