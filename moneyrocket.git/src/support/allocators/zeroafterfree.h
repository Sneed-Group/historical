...
#ifndef MONEYROCKET_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define MONEYROCKET_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // MONEYROCKET_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
