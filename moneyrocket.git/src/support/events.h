// Copyright (c) 2016-2018 The Moneyrocket Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MONEYROCKET_SUPPORT_EVENTS_H
#define MONEYROCKET_SUPPORT_EVENTS_H
...
#endif // MONEYROCKET_SUPPORT_EVENTS_H
