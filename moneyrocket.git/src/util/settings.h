...
#ifndef MONEYROCKET_UTIL_SETTINGS_H
#define MONEYROCKET_UTIL_SETTINGS_H
...
//!       https://github.com/moneyrocket/moneyrocket/pull/15934/files#r337691812)
...
#endif // MONEYROCKET_UTIL_SETTINGS_H
