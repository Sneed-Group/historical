...
#ifndef MONEYROCKET_UTIL_SYSCALL_SANDBOX_H
#define MONEYROCKET_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during moneyrocketd initialization if Moneyrocket Core was compiled
...
#endif // MONEYROCKET_UTIL_SYSCALL_SANDBOX_H
