...
#ifndef MONEYROCKET_UTIL_MESSAGE_H
#define MONEYROCKET_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's moneyrocket address, it must refer to a public key.
...
#endif // MONEYROCKET_UTIL_MESSAGE_H
