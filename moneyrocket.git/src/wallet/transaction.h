...
#ifndef MONEYROCKET_WALLET_TRANSACTION_H
#define MONEYROCKET_WALLET_TRANSACTION_H
...
public:
     ...
     * on this moneyrocket node, and set to 0 for transactions that were created
...
#endif // MONEYROCKET_WALLET_TRANSACTION_H
