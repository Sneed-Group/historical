...
#ifndef MONEYROCKET_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MONEYROCKET_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MONEYROCKET_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
