...
#ifndef MONEYROCKET_WALLET_SCRIPTPUBKEYMAN_H
#define MONEYROCKET_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Moneyrocket Core wallet was originally a collection of unrelated private
...
#endif // MONEYROCKET_WALLET_SCRIPTPUBKEYMAN_H
