...
#ifndef MONEYROCKET_WALLET_WALLETUTIL_H
#define MONEYROCKET_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! moneyrocket from opening the wallet, thinking it was newly created, and
...
#endif // MONEYROCKET_WALLET_WALLETUTIL_H
