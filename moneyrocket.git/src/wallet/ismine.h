...
#ifndef MONEYROCKET_WALLET_ISMINE_H
#define MONEYROCKET_WALLET_ISMINE_H
 ...
 * https://github.com/moneyrocket/moneyrocket/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // MONEYROCKET_WALLET_ISMINE_H
