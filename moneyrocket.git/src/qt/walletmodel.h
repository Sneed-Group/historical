...
#ifndef MONEYROCKET_QT_WALLETMODEL_H
#define MONEYROCKET_QT_WALLETMODEL_H
...
/** Interface to Moneyrocket wallet from Qt view code. */
...
#endif // MONEYROCKET_QT_WALLETMODEL_H
