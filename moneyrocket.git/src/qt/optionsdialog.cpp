      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->moneyrocketAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->moneyrocketAtStartup);
    ...
    ui->moneyrocketAtStartup->setToolTip(ui->moneyrocketAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->moneyrocketAtStartup->setText(ui->moneyrocketAtStartup->text().arg(PACKAGE_NAME));

    ui->openMoneyrocketConfButton->setToolTip(ui->openMoneyrocketConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MoneyrocketUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->moneyrocketAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSRKTontrols);
...
void OptionsDialog::on_openMoneyrocketConfButton_clicked()
{
    ...
    if (!GUIUtil::openMoneyrocketConf())
