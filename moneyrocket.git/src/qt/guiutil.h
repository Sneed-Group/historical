...
#ifndef MONEYROCKET_QT_GUIUTIL_H
#define MONEYROCKET_QT_GUIUTIL_H
...
/** Utility functions used by the Moneyrocket Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "moneyrocket:" URI into recipient object, return true on successful parsing
...
#endif // MONEYROCKET_QT_GUIUTIL_H
