...
#ifndef MONEYROCKET_QT_OPTIONSDIALOG_H
#define MONEYROCKET_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openMoneyrocketConfButton_clicked();
...
#endif // MONEYROCKET_QT_OPTIONSDIALOG_H
