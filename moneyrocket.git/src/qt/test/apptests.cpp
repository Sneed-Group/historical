...
//! Entry point for MoneyrocketApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MoneyrocketApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MoneyrocketGUI tests.
void AppTests::guiTests(MoneyrocketGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MoneyrocketGUI::consoleShown, this, &AppTests::consoleTests);
