...
{
    // Test regression https://github.com/moneyrocket/moneyrocket/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/moneyrocket-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/moneyrocket-core/gui/pull/568.
    // With fListen=false in ~/.config/Moneyrocket/Moneyrocket-Qt.conf and all else left as default,
    // moneyrocket-qt should set both -listen and -listenonion to false and start successfully.
