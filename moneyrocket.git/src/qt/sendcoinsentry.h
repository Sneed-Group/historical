...
#ifndef MONEYROCKET_QT_SENDCOINSENTRY_H
#define MONEYROCKET_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending moneyrockets.
 */
...
#endif // MONEYROCKET_QT_SENDCOINSENTRY_H
