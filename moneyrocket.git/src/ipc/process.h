...
#ifndef MONEYROCKET_IPC_PROCESS_H
#define MONEYROCKET_IPC_PROCESS_H
...
//! IPC process interface for spawning moneyrocket processes and serving requests
...
#endif // MONEYROCKET_IPC_PROCESS_H
