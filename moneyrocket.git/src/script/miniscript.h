...
#ifndef MONEYROCKET_SCRIPT_MINISCRIPT_H
#define MONEYROCKET_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a moneyrocket script
...
#endif // MONEYROCKET_SCRIPT_MINISCRIPT_H
