...
#ifndef MONEYROCKET_SCRIPT_SCRIPT_H
#define MONEYROCKET_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Moneyrocket always counted CHECKMULTISIGs
...
#endif // MONEYROCKET_SCRIPT_SCRIPT_H
