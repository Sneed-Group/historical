...
#ifndef MONEYROCKET_SCRIPT_STANDARD_H
#define MONEYROCKET_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a moneyrocket address
 */
...
/**
 * Generate a Moneyrocket scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MONEYROCKET_SCRIPT_STANDARD_H
