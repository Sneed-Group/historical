...
#ifndef MONEYROCKET_NODE_CONNECTION_TYPES_H
#define MONEYROCKET_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/moneyrocket-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Moneyrocket’s Peer-to-Peer Network")
...
#endif // MONEYROCKET_NODE_CONNECTION_TYPES_H
