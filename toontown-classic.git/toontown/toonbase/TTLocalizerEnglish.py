...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 7000: ('to the', 'in the', 'Farm'),
 7100: ('to', 'on', 'Construction Blvd'),
 7200: ('to', 'on', 'Sneed Street'),
 7300: ('to', 'on', 'Loony Lane'),
...
QuestDialogDict = {160: {GREETING: '',
 ...
 1078: {QUEST: "Oh, you have my fish!\x07Huh?  What's this - a receipt?\x07Sigh, I guess they are Cogs, after all.\x07I can't make heads or tails out of this receipt.  Could you take it to _toNpcName_ and see if he can read it?_where_",
        ...
        LEAVING: ''},
 1079: {QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a SamBot.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that SamBot.",
        LEAVING: '',
 ...
 12001: {GREETING: '',
         LEAVING: '',
         QUEST: "Yes, I can get you Bossbot parts.\x07But I'll need you to help me complete my Bossbot collection.\x07Go out there and defeat a SamBot.",
         INCOMPLETE_PROGRESS: "You can't find a SamBot? For shame...",
...
FADoorCodes_DEFEAT_FLUNKY_HQ = 'Come back here when you have defeated the SamBot!'
...
FADoorCodes_DEFEAT_FLUNKY_TOM = 'Walk up to that SamBot to battle him!'
...
QuestScript101_14 = 'Hurry up! Go defeat that SamBot!'
QuestScript110_1 = 'Good work defeating that SamBot. Let me give you a Shticker Book...'
...
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'),
 ...
 45: ('The Trouble With Bossbots 1', 'The Trouble with Bossbots. Stop the SamBot Cogs from invading Toontown!'),
